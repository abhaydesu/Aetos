        ...
        <main className="max-w-7xl mt-10 mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p
              ...
              variants={fadeInUp}
            >
              AETOS is an AI-powered platform that automates technology intelligence, providing
              real-time forecasting and comprehensive insights to accelerate strategic decision-making for DRDO.
            </motion.p>
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                className="dark:border-white/[0.2] flex flex-col items-start relative max-w-sm mx-auto bg-neutral-900/50 border transition border-neutral-800 p-6"
              >
                <FloatingCorners />
                <motion.div
                  aria-hidden
...
/**
 * Decorative corner icons that softly fade in (kept as a small component for reuse).
 */
function FloatingCorners() {
  return (
    <>
      <motion.span
        className="absolute h-6 w-6 -top-3 -left-3 dark:text-sky-700 text-black"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <motion.span
        className="absolute h-6 w-6 -bottom-3 -left-3 dark:text-sky-700 text-black"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <motion.span
        className="absolute h-6 w-6 -top-3 -right-3 dark:text-sky-700 text-black"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <motion.span
        className="absolute h-6 w-6 -bottom-3 -right-3 dark:text-sky-700 text-black"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
